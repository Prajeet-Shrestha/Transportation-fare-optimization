...
console.log(
  findShortestPath(graph_route, 'dhulikhel_mini', 'sinamangal_tempo')
);
console.log(findShortestPath(graph_route, 'dhulikhel_tempo', 'sinamangal_bus'));
console.log(
  findShortestPath(graph_route, 'dhulikhel_tempo', 'sinamangal_mini')
);
console.log(
  findShortestPath(graph_route, 'dhulikhel_tempo', 'sinamangal_tempo')
);
